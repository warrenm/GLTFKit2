...
let package = Package(
    ...
    targets: [
        .binaryTarget(name: "GLTFKit2",
                      url: "https://github.com/warrenm/GLTFKit2/releases/download/0.5.7/GLTFKit2.xcframework.zip",
                      checksum:"4b1e8fc2cb9c20ace86eee3b0697ed27ed00acd0c708957d0edda985531cab5c")
    ]
)
